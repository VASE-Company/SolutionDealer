<?php 
    ...
    if ($warehouse['id'] > 0) {
        ...
        $id = set_value('id',$warehouse['id']);
    }
?>
<div class="card card-secondary">
    <div class="card-body">
        <form class="form-horizontal" action="<?php echo base_url(); ?>warehouses/save" method="post" accept-charset="utf-8" id="frmData" name="frmData" role="form"  onsubmit="return preSubmit();">
                        ...
                        <?php 
                            for($i=0; $i < count($states); $i++) {
                                if (validation_errors() != "" || (isset($error) && $error != "")) {
                                    ...
                                    $selected = ($warehouse['active'] == $states[$i]['id']?' selected="selected" ':'');                  
                                }
                        ?>
            ...
            <div class="form-group row" style="margin-top:20px;">           
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">      
                    <?php if ($allowSave) { ?>
                        ...
                        <button type="button" class="btn btn-danger type-btn-save" onclick="getUrl('<?php echo base_url(); ?>warehouses')">Cancelar</button>                                            
                    <?php } else { ?>                        
                        <button type="button" class="btn btn-success type-btn-save" onclick="getUrl('<?php echo base_url(); ?>warehouses')">Volver</button>                                            
                    <?php } ?>
                </div>
            </div>
...
<!-- /.card -->     
<?php 
/* End of file warehouses_edit_view.php */
/* Location: ./application/views/warehouses/warehouses_edit_view.php */