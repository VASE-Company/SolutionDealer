                    ...
                    <div class="form-group">                                                                        
                        <div class="input-group input-group-sm">
                            ...
                            <span class="input-group-append">
                                <button type="button" class="btn btn-default btn-flat" onclick="searchFinderBillEdit('suppliers')" title="buscar"><i class="fas fa-search"></i></button>
                                <button type="button" class="btn btn-default btn-flat" onclick="searchFinderBillEdit('suppliers',true)" title="limpiar filtros"><i class="fa fa-undo"></i></button>
                            </span>
                        </div>
                    </div>                                                                                                     
                </div>                                                        
            ...
            <tbody>
                ...
                <tr>                                
                    ...
                    <td class="text-center without-padding">                                                                                                                                                
                        <button type="button" class="btn btn-sm btn-info" onclick="acceptSuppliersFinderBillEdit(<?php echo ($i + 1); ?>)" title="aceptar">
                            OK
                        </button>  
...
?>      
<?php 
/* End of file bills_finder_suppliers_view.php */
/* Location: ./application/views/bills/bills_finder_suppliers_view.php */