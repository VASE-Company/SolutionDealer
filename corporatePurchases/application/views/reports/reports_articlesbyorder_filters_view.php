...
<div class="row">
    ...
    <div class="form-group" style="width:180px; float:left; margin-right:10px;">
...
<?php
/* End of file reports_articlesbyorder_filters_view.php */
/* Location: ./application/views/reports/reports_articlesbyorder_filters_view.php */
